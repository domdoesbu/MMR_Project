...
/// The array must be destroyed using `MR_std_function_float_from_MR_EdgeId_DestroyArray()`.
/// Use `MR_std_function_float_from_MR_EdgeId_OffsetMutablePtr()` and `MR_std_function_float_from_MR_EdgeId_OffsetPtr()` to access the array elements.
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_function_float_from_MR_EdgeId_Destroy()` to free it when you're done using it.
MRC_API MR_std_function_float_from_MR_EdgeId *MR_std_function_float_from_MR_EdgeId_ConstructFromAnother(MR_PassBy other_pass_by, MR_std_function_float_from_MR_EdgeId *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_function_float_from_MR_EdgeId_AssignFromAnother(MR_std_function_float_from_MR_EdgeId *_this, MR_PassBy other_pass_by, MR_std_function_float_from_MR_EdgeId *other);
...
MRC_API const MR_std_function_float_from_MR_EdgeId *MR_std_function_float_from_MR_EdgeId_OffsetPtr(const MR_std_function_float_from_MR_EdgeId *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API MR_std_function_float_from_MR_EdgeId *MR_std_function_float_from_MR_EdgeId_OffsetMutablePtr(MR_std_function_float_from_MR_EdgeId *ptr, ptrdiff_t i);
...
MRC_API void MR_std_function_float_from_MR_EdgeId_Assign(MR_std_function_float_from_MR_EdgeId *_this, float (*func)(MR_EdgeId *_1));
...
MRC_API void MR_std_function_float_from_MR_EdgeId_AssignWithDataPtr(MR_std_function_float_from_MR_EdgeId *_this, float (*func)(MR_EdgeId *_1, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
