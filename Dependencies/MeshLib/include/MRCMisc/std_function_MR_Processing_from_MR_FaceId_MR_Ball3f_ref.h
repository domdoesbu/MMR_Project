...
/// Stores a functor of type: `MR::Processing(MR::FaceId, MR::Ball3f &)`. Possibly stateful.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref_Destroy()` to free it when you're done using it.
...
/// The array must be destroyed using `MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref_DestroyArray()`.
/// Use `MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref_OffsetMutablePtr()` and `MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_function_MR_Processing_from_MR_FaceId_MR_Ball3f_ref`. Does nothing if the pointer is null.
