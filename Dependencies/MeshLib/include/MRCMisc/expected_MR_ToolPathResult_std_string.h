...
typedef struct MR_ToolPathResult MR_ToolPathResult; // Defined in `#include <MRCVoxels/MRToolPath.h>`.
typedef struct MR_std_string MR_std_string; // Defined in `#include <MRCMisc/std_string.h>`.


/// Stores either a `MR::ToolPathResult` that represents success or a `std::string` that represents an error.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_expected_MR_ToolPathResult_std_string MR_expected_MR_ToolPathResult_std_string;
...
/// The array must be destroyed using `MR_expected_MR_ToolPathResult_std_string_DestroyArray()`.
/// Use `MR_expected_MR_ToolPathResult_std_string_OffsetMutablePtr()` and `MR_expected_MR_ToolPathResult_std_string_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_expected_MR_ToolPathResult_std_string`. Does nothing if the pointer is null.
MRC_API void MR_expected_MR_ToolPathResult_std_string_Destroy(const MR_expected_MR_ToolPathResult_std_string *_this);

/// Destroys a heap-allocated array of `MR_expected_MR_ToolPathResult_std_string`. Does nothing if the pointer is null.
...
/// If this instance represents success, returns the stored `MR::ToolPathResult`. Otherwise null.
/// Parameter `_this` can not be null. It is a single object.
...
/// If this instance represents success, returns the stored `MR::ToolPathResult`. Otherwise null. This version returns a mutable pointer.
/// Parameter `_this` can not be null. It is a single object.
