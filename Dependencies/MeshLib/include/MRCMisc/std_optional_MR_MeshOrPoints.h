...
/// Stores either a single `MR::MeshOrPoints` or nothing.
...
typedef struct MR_std_optional_MR_MeshOrPoints MR_std_optional_MR_MeshOrPoints;
...
/// Destroys a heap-allocated instance of `MR_std_optional_MR_MeshOrPoints`. Does nothing if the pointer is null.
MRC_API void MR_std_optional_MR_MeshOrPoints_Destroy(const MR_std_optional_MR_MeshOrPoints *_this);

/// Destroys a heap-allocated array of `MR_std_optional_MR_MeshOrPoints`. Does nothing if the pointer is null.
