...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref_Destroy()` to free it when you're done using it.
...
/// The array must be destroyed using `MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref_DestroyArray()`.
/// Use `MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref_OffsetMutablePtr()` and `MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref`. Does nothing if the pointer is null.
...
MRC_API void MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref_AssignWithDataPtr(MR_std_function_void_from_MR_Mesh_ref_const_MR_PartMapping_ref *_this, void (*func)(MR_Mesh *_1, const MR_PartMapping *_2, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
