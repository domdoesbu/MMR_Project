...
typedef struct MR_FeatureObjectSharedProperty MR_FeatureObjectSharedProperty; // Defined in `#include <MRCMesh/MRFeatureObject.h>`.


/// Generated from C++ container `std::vector<MR::FeatureObjectSharedProperty>`.
...
/// Read-only iterator for `MR_std_vector_MR_FeatureObjectSharedProperty`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator;

/// Mutable iterator for `MR_std_vector_MR_FeatureObjectSharedProperty`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_MR_FeatureObjectSharedProperty_iterator MR_std_vector_MR_FeatureObjectSharedProperty_iterator;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_MR_FeatureObjectSharedProperty_Destroy()` to free it when you're done using it.
...
/// The array must be destroyed using `MR_std_vector_MR_FeatureObjectSharedProperty_DestroyArray()`.
/// Use `MR_std_vector_MR_FeatureObjectSharedProperty_OffsetMutablePtr()` and `MR_std_vector_MR_FeatureObjectSharedProperty_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_MR_FeatureObjectSharedProperty`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_vector_MR_FeatureObjectSharedProperty`. Does nothing if the pointer is null.
...
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator_Destroy()` to free it when you're done using it.
...
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_MR_FeatureObjectSharedProperty_iterator_Destroy()` to free it when you're done using it.
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator_DestroyArray()`.
/// Use `MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator_OffsetMutablePtr()` and `MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_vector_MR_FeatureObjectSharedProperty_const_iterator`. Does nothing if the pointer is null.
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_MR_FeatureObjectSharedProperty_iterator_DestroyArray()`.
/// Use `MR_std_vector_MR_FeatureObjectSharedProperty_iterator_OffsetMutablePtr()` and `MR_std_vector_MR_FeatureObjectSharedProperty_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_MR_FeatureObjectSharedProperty_iterator`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_vector_MR_FeatureObjectSharedProperty_iterator`. Does nothing if the pointer is null.
