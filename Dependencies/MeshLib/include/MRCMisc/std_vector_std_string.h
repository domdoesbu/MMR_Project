...
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_std_string_const_iterator MR_std_vector_std_string_const_iterator;

/// Mutable iterator for `MR_std_vector_std_string`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_std_string_iterator MR_std_vector_std_string_iterator;
...
/// The array must be destroyed using `MR_std_vector_std_string_DestroyArray()`.
/// Use `MR_std_vector_std_string_OffsetMutablePtr()` and `MR_std_vector_std_string_OffsetPtr()` to access the array elements.
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API bool MR_std_vector_std_string_IsEmpty(const MR_std_vector_std_string *_this);
...
MRC_API void MR_std_vector_std_string_ResizeWithDefaultValue(MR_std_vector_std_string *_this, size_t new_size, const MR_std_string *value);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_std_string_ShrinkToFit(MR_std_vector_std_string *_this);
...
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MRC_API MR_std_string *MR_std_vector_std_string_MutableAt(MR_std_vector_std_string *_this, size_t i);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API MR_std_string *MR_std_vector_std_string_MutableFront(MR_std_vector_std_string *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API MR_std_string *MR_std_vector_std_string_MutableBack(MR_std_vector_std_string *_this);

/// Inserts a new element at the end.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `new_elem` can not be null.
/// If `new_elem_end` is null, then `new_elem` is assumed to be null-terminated.
MRC_API void MR_std_vector_std_string_PushBack(MR_std_vector_std_string *_this, const char *new_elem, const char *new_elem_end);

/// Removes one element from the end.
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_std_string_PopBack(MR_std_vector_std_string *_this);
...
/// Parameter `new_elem` can not be null.
/// If `new_elem_end` is null, then `new_elem` is assumed to be null-terminated.
MRC_API void MR_std_vector_std_string_InsertAtMutableIter(MR_std_vector_std_string *_this, const MR_std_vector_std_string_iterator *position, const char *new_elem, const char *new_elem_end);

/// Erases the element at the specified position.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `position` can not be null. It is a single object.
MRC_API void MR_std_vector_std_string_EraseAtMutableIter(MR_std_vector_std_string *_this, const MR_std_vector_std_string_iterator *position);
...
/// Parameter `new_elem` can not be null.
/// If `new_elem_end` is null, then `new_elem` is assumed to be null-terminated.
MRC_API void MR_std_vector_std_string_InsertAtIter(MR_std_vector_std_string *_this, const MR_std_vector_std_string_const_iterator *position, const char *new_elem, const char *new_elem_end);

/// Erases the element at the specified position. This version takes the position in form of a const iterator, that's the only difference.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `position` can not be null. It is a single object.
MRC_API void MR_std_vector_std_string_EraseAtIter(MR_std_vector_std_string *_this, const MR_std_vector_std_string_const_iterator *position);

/// The begin iterator, const.
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_std_string_const_iterator_Destroy()` to free it when you're done using it.
...
MRC_API bool MR_std_vector_std_string_IsBegin(const MR_std_vector_std_string *_this, const MR_std_vector_std_string_const_iterator *iter);

/// The begin iterator, mutable.
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_std_string_iterator_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_std_string_iterator *MR_std_vector_std_string_MutableBegin(MR_std_vector_std_string *_this);

/// Tests whether a mutable iterator is the begin iterator.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API bool MR_std_vector_std_string_IsMutableBegin(MR_std_vector_std_string *_this, const MR_std_vector_std_string_iterator *iter);
...
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API bool MR_std_vector_std_string_IsEnd(const MR_std_vector_std_string *_this, const MR_std_vector_std_string_const_iterator *iter);

/// The end iterator, mutable.
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_std_string_iterator_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_std_string_iterator *MR_std_vector_std_string_MutableEnd(MR_std_vector_std_string *_this);

/// Tests whether a mutable iterator is the end iterator.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API bool MR_std_vector_std_string_IsMutableEnd(MR_std_vector_std_string *_this, const MR_std_vector_std_string_iterator *iter);

/// Convert a const iterator to an index.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_std_string_ToIndex(const MR_std_vector_std_string *_this, const MR_std_vector_std_string_const_iterator *iter);

/// Convert a mutable iterator to an index.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_std_string_MutableToIndex(const MR_std_vector_std_string *_this, const MR_std_vector_std_string_iterator *iter);
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_std_string_const_iterator_DestroyArray()`.
/// Use `MR_std_vector_std_string_const_iterator_OffsetMutablePtr()` and `MR_std_vector_std_string_const_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_std_string_const_iterator`. Does nothing if the pointer is null.
MRC_API void MR_std_vector_std_string_const_iterator_Destroy(const MR_std_vector_std_string_const_iterator *_this);

/// Destroys a heap-allocated array of `MR_std_vector_std_string_const_iterator`. Does nothing if the pointer is null.
...
/// Parameter `iter` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_std_string_const_iterator_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_std_string_const_iterator *MR_std_vector_std_string_const_iterator_FromMutable(const MR_std_vector_std_string_iterator *iter);
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_std_string_iterator_DestroyArray()`.
/// Use `MR_std_vector_std_string_iterator_OffsetMutablePtr()` and `MR_std_vector_std_string_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_std_string_iterator`. Does nothing if the pointer is null.
MRC_API void MR_std_vector_std_string_iterator_Destroy(const MR_std_vector_std_string_iterator *_this);

/// Destroys a heap-allocated array of `MR_std_vector_std_string_iterator`. Does nothing if the pointer is null.
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_std_string_const_iterator_OffsetBy(MR_std_vector_std_string_const_iterator *_this, ptrdiff_t delta);

/// Computes the signed difference between two const iterators. Completes in constant time.
/// Parameter `a` can not be null. It is a single object.
/// Parameter `b` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_std_string_const_iterator_Distance(const MR_std_vector_std_string_const_iterator *a, const MR_std_vector_std_string_const_iterator *b);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_std_string_iterator_OffsetBy(MR_std_vector_std_string_iterator *_this, ptrdiff_t delta);

/// Computes the signed difference between two mutable iterators. Completes in constant time.
/// Parameter `a` can not be null. It is a single object.
/// Parameter `b` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_std_string_iterator_Distance(const MR_std_vector_std_string_iterator *a, const MR_std_vector_std_string_iterator *b);
