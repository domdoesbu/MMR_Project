...
/// A fixed-size array of `MR::PreciseVertCoords` of size 5.
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_array_MR_PreciseVertCoords_5_Destroy()` to free it when you're done using it.
...
/// The array must be destroyed using `MR_std_array_MR_PreciseVertCoords_5_DestroyArray()`.
/// Use `MR_std_array_MR_PreciseVertCoords_5_OffsetMutablePtr()` and `MR_std_array_MR_PreciseVertCoords_5_OffsetPtr()` to access the array elements.
...
MRC_API const MR_std_array_MR_PreciseVertCoords_5 *MR_std_array_MR_PreciseVertCoords_5_OffsetPtr(const MR_std_array_MR_PreciseVertCoords_5 *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API MR_std_array_MR_PreciseVertCoords_5 *MR_std_array_MR_PreciseVertCoords_5_OffsetMutablePtr(MR_std_array_MR_PreciseVertCoords_5 *ptr, ptrdiff_t i);

/// The element at a specific index, read-only.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MRC_API const MR_PreciseVertCoords *MR_std_array_MR_PreciseVertCoords_5_At(const MR_std_array_MR_PreciseVertCoords_5 *_this, size_t i);

/// The element at a specific index, mutable.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MRC_API MR_PreciseVertCoords *MR_std_array_MR_PreciseVertCoords_5_MutableAt(MR_std_array_MR_PreciseVertCoords_5 *_this, size_t i);
