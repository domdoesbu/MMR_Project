...
/// Stores two objects: `MR::FaceId` and `MR::FaceId`.
...
/// The array must be destroyed using `MR_std_pair_MR_FaceId_bool_DestroyArray()`.
/// Use `MR_std_pair_MR_FaceId_bool_OffsetMutablePtr()` and `MR_std_pair_MR_FaceId_bool_OffsetPtr()` to access the array elements.
