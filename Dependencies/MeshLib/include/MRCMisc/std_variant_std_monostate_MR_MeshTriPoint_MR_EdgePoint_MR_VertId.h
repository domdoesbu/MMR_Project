...
typedef struct MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId;
...
/// The array must be destroyed using `MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_DestroyArray()`.
/// Use `MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_OffsetMutablePtr()` and `MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_OffsetPtr()` to access the array elements.
...
/// Parameter `other` can not be null. It is a single object.
MRC_API void MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_AssignFromAnother(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *_this, const MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *other);
...
MRC_API const MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_OffsetPtr(const MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_OffsetMutablePtr(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *ptr, ptrdiff_t i);
...
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `value` can not be null. It is a single object.
MRC_API void MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_AssignAs_MR_MeshTriPoint(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *_this, const MR_MeshTriPoint *value);

/// Assigns to the variant, making it store the element 2, of type `MR::EdgePoint`.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `value` can not be null. It is a single object.
MRC_API void MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_AssignAs_MR_EdgePoint(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *_this, const MR_EdgePoint *value);

/// Assigns to the variant, making it store the element 3, of type `MR::VertId`.
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_AssignAs_MR_VertId(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *_this, MR_VertId value);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API MR_MeshTriPoint *MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_GetMutable_MR_MeshTriPoint(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API MR_EdgePoint *MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_GetMutable_MR_EdgePoint(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API MR_VertId *MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId_GetMutable_MR_VertId(MR_std_variant_std_monostate_MR_MeshTriPoint_MR_EdgePoint_MR_VertId *_this);
