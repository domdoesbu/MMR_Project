...
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator;

/// Mutable iterator for `MR_std_vector_std_shared_ptr_MR_ObjectLines`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_std_shared_ptr_MR_ObjectLines_Destroy()` to free it when you're done using it.
...
/// The array must be destroyed using `MR_std_vector_std_shared_ptr_MR_ObjectLines_DestroyArray()`.
/// Use `MR_std_vector_std_shared_ptr_MR_ObjectLines_OffsetMutablePtr()` and `MR_std_vector_std_shared_ptr_MR_ObjectLines_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_std_shared_ptr_MR_ObjectLines`. Does nothing if the pointer is null.
MRC_API void MR_std_vector_std_shared_ptr_MR_ObjectLines_Destroy(const MR_std_vector_std_shared_ptr_MR_ObjectLines *_this);

/// Destroys a heap-allocated array of `MR_std_vector_std_shared_ptr_MR_ObjectLines`. Does nothing if the pointer is null.
...
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator_Destroy()` to free it when you're done using it.
...
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator_Destroy()` to free it when you're done using it.
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator_DestroyArray()`.
/// Use `MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator_OffsetMutablePtr()` and `MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_vector_std_shared_ptr_MR_ObjectLines_const_iterator`. Does nothing if the pointer is null.
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator_DestroyArray()`.
/// Use `MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator_OffsetMutablePtr()` and `MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_vector_std_shared_ptr_MR_ObjectLines_iterator`. Does nothing if the pointer is null.
