...
/// The array must be destroyed using `MR_std_string_DestroyArray()`.
/// Use `MR_std_string_OffsetMutablePtr()` and `MR_std_string_OffsetPtr()` to access the array elements.
