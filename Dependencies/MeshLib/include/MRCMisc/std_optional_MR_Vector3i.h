...
/// The array must be destroyed using `MR_std_optional_MR_Vector3i_DestroyArray()`.
/// Use `MR_std_optional_MR_Vector3i_OffsetMutablePtr()` and `MR_std_optional_MR_Vector3i_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_optional_MR_Vector3i`. Does nothing if the pointer is null.
