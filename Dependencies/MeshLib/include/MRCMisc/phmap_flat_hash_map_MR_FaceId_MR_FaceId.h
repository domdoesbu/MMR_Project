...
/// Generated from C++ container `phmap::flat_hash_map<MR::FaceId, MR::FaceId>`.
...
/// Read-only iterator for `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator;

/// Mutable iterator for `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_Destroy()` to free it when you're done using it.
...
/// The array must be destroyed using `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_DestroyArray()`.
/// Use `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_OffsetMutablePtr()` and `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId`. Does nothing if the pointer is null.
MRC_API void MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_Destroy(const MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId *_this);

/// Destroys a heap-allocated array of `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId`. Does nothing if the pointer is null.
...
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `key` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator_Destroy()` to free it when you're done using it.
...
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `key` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator_Destroy()` to free it when you're done using it.
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator_DestroyArray()`.
/// Use `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator_OffsetMutablePtr()` and `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_const_iterator`. Does nothing if the pointer is null.
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator_DestroyArray()`.
/// Use `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator_OffsetMutablePtr()` and `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_phmap_flat_hash_map_MR_FaceId_MR_FaceId_iterator`. Does nothing if the pointer is null.
