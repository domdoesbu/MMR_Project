...
/// The array must be destroyed using `MR_std_function_bool_from_float_DestroyArray()`.
/// Use `MR_std_function_bool_from_float_OffsetMutablePtr()` and `MR_std_function_bool_from_float_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_function_bool_from_float`. Does nothing if the pointer is null.
MRC_API void MR_std_function_bool_from_float_Destroy(const MR_std_function_bool_from_float *_this);

/// Destroys a heap-allocated array of `MR_std_function_bool_from_float`. Does nothing if the pointer is null.
