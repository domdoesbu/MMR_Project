...
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_double_const_iterator MR_std_vector_double_const_iterator;

/// Mutable iterator for `MR_std_vector_double`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_double_iterator MR_std_vector_double_iterator;
...
/// The array must be destroyed using `MR_std_vector_double_DestroyArray()`.
/// Use `MR_std_vector_double_OffsetMutablePtr()` and `MR_std_vector_double_OffsetPtr()` to access the array elements.
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API bool MR_std_vector_double_IsEmpty(const MR_std_vector_double *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_double_ResizeWithDefaultValue(MR_std_vector_double *_this, size_t new_size, double value);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_double_ShrinkToFit(MR_std_vector_double *_this);
...
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MRC_API double *MR_std_vector_double_MutableAt(MR_std_vector_double *_this, size_t i);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API double *MR_std_vector_double_MutableFront(MR_std_vector_double *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API double *MR_std_vector_double_MutableBack(MR_std_vector_double *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API double *MR_std_vector_double_MutableData(MR_std_vector_double *_this);

/// Inserts a new element at the end.
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_double_PushBack(MR_std_vector_double *_this, double new_elem);

/// Removes one element from the end.
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_double_PopBack(MR_std_vector_double *_this);
...
MRC_API void MR_std_vector_double_InsertAtMutableIter(MR_std_vector_double *_this, const MR_std_vector_double_iterator *position, double new_elem);

/// Erases the element at the specified position.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `position` can not be null. It is a single object.
MRC_API void MR_std_vector_double_EraseAtMutableIter(MR_std_vector_double *_this, const MR_std_vector_double_iterator *position);

/// Inserts a new element right before the specified position. This version takes the position in form of a const iterator, that's the only difference.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `position` can not be null. It is a single object.
MRC_API void MR_std_vector_double_InsertAtIter(MR_std_vector_double *_this, const MR_std_vector_double_const_iterator *position, double new_elem);

/// Erases the element at the specified position. This version takes the position in form of a const iterator, that's the only difference.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `position` can not be null. It is a single object.
MRC_API void MR_std_vector_double_EraseAtIter(MR_std_vector_double *_this, const MR_std_vector_double_const_iterator *position);

/// The begin iterator, const.
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_double_const_iterator_Destroy()` to free it when you're done using it.
...
MRC_API bool MR_std_vector_double_IsBegin(const MR_std_vector_double *_this, const MR_std_vector_double_const_iterator *iter);

/// The begin iterator, mutable.
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_double_iterator_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_double_iterator *MR_std_vector_double_MutableBegin(MR_std_vector_double *_this);

/// Tests whether a mutable iterator is the begin iterator.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API bool MR_std_vector_double_IsMutableBegin(MR_std_vector_double *_this, const MR_std_vector_double_iterator *iter);
...
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API bool MR_std_vector_double_IsEnd(const MR_std_vector_double *_this, const MR_std_vector_double_const_iterator *iter);

/// The end iterator, mutable.
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_double_iterator_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_double_iterator *MR_std_vector_double_MutableEnd(MR_std_vector_double *_this);

/// Tests whether a mutable iterator is the end iterator.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API bool MR_std_vector_double_IsMutableEnd(MR_std_vector_double *_this, const MR_std_vector_double_iterator *iter);

/// Convert a const iterator to an index.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_double_ToIndex(const MR_std_vector_double *_this, const MR_std_vector_double_const_iterator *iter);

/// Convert a mutable iterator to an index.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_double_MutableToIndex(const MR_std_vector_double *_this, const MR_std_vector_double_iterator *iter);
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_double_const_iterator_DestroyArray()`.
/// Use `MR_std_vector_double_const_iterator_OffsetMutablePtr()` and `MR_std_vector_double_const_iterator_OffsetPtr()` to access the array elements.
...
/// Parameter `iter` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_double_const_iterator_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_double_const_iterator *MR_std_vector_double_const_iterator_FromMutable(const MR_std_vector_double_iterator *iter);
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_double_iterator_DestroyArray()`.
/// Use `MR_std_vector_double_iterator_OffsetMutablePtr()` and `MR_std_vector_double_iterator_OffsetPtr()` to access the array elements.
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_double_const_iterator_OffsetBy(MR_std_vector_double_const_iterator *_this, ptrdiff_t delta);

/// Computes the signed difference between two const iterators. Completes in constant time.
/// Parameter `a` can not be null. It is a single object.
/// Parameter `b` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_double_const_iterator_Distance(const MR_std_vector_double_const_iterator *a, const MR_std_vector_double_const_iterator *b);
...
/// Parameter `_this` can not be null. It is a single object.
MRC_API void MR_std_vector_double_iterator_OffsetBy(MR_std_vector_double_iterator *_this, ptrdiff_t delta);

/// Computes the signed difference between two mutable iterators. Completes in constant time.
/// Parameter `a` can not be null. It is a single object.
/// Parameter `b` can not be null. It is a single object.
MRC_API ptrdiff_t MR_std_vector_double_iterator_Distance(const MR_std_vector_double_iterator *a, const MR_std_vector_double_iterator *b);
