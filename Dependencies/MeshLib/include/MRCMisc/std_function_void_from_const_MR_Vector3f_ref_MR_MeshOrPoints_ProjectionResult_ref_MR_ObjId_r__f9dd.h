...
/// Stores a functor of type: `void(const MR::Vector3f &, MR::MeshOrPoints::ProjectionResult &, MR::ObjId &)`. Possibly stateful.
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref_Destroy()` to free it when you're done using it.
...
/// The array must be destroyed using `MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref_DestroyArray()`.
/// Use `MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref_OffsetMutablePtr()` and `MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref`. Does nothing if the pointer is null.
...
/// Destroys a heap-allocated array of `MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref`. Does nothing if the pointer is null.
...
MRC_API void MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref_AssignWithDataPtr(MR_std_function_void_from_const_MR_Vector3f_ref_MR_MeshOrPoints_ProjectionResult_ref_MR_ObjId_ref *_this, void (*func)(const MR_Vector3f *_1, MR_MeshOrPoints_ProjectionResult *_2, MR_ObjId *_3, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
