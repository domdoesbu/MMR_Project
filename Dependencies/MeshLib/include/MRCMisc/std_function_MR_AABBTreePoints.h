...
/// Stores a functor of type: `MR::AABBTreePoints(void)`. Possibly stateful.
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_function_MR_AABBTreePoints_Destroy()` to free it when you're done using it.
MRC_API MR_std_function_MR_AABBTreePoints *MR_std_function_MR_AABBTreePoints_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_function_MR_AABBTreePoints_DestroyArray()`.
/// Use `MR_std_function_MR_AABBTreePoints_OffsetMutablePtr()` and `MR_std_function_MR_AABBTreePoints_OffsetPtr()` to access the array elements.
...
/// Destroys a heap-allocated instance of `MR_std_function_MR_AABBTreePoints`. Does nothing if the pointer is null.
MRC_API void MR_std_function_MR_AABBTreePoints_Destroy(const MR_std_function_MR_AABBTreePoints *_this);

/// Destroys a heap-allocated array of `MR_std_function_MR_AABBTreePoints`. Does nothing if the pointer is null.
