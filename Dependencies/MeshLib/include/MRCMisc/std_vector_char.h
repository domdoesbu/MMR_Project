...
/// Generated from C++ container `std::vector<char>`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_char MR_std_vector_char;

/// Read-only iterator for `MR_std_vector_char`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_char_const_iterator MR_std_vector_char_const_iterator;

/// Mutable iterator for `MR_std_vector_char`.
/// Supported `MR_PassBy` modes: `MR_PassBy_DefaultConstruct`, `MR_PassBy_Copy`, `MR_PassBy_Move`, (and `MR_PassBy_DefaultArgument` and `MR_PassBy_NoObject` if supported by the callee).
typedef struct MR_std_vector_char_iterator MR_std_vector_char_iterator;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_char_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_char *MR_std_vector_char_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_char_DestroyArray()`.
/// Use `MR_std_vector_char_OffsetMutablePtr()` and `MR_std_vector_char_OffsetPtr()` to access the array elements.
MRC_API MR_std_vector_char *MR_std_vector_char_DefaultConstructArray(size_t num_elems);

/// Constructs a copy of another instance. The source remains alive.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_char_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_char *MR_std_vector_char_ConstructFromAnother(MR_PassBy other_pass_by, MR_std_vector_char *other);
...
MRC_API const MR_std_vector_char *MR_std_vector_char_OffsetPtr(const MR_std_vector_char *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API MR_std_vector_char *MR_std_vector_char_OffsetMutablePtr(MR_std_vector_char *ptr, ptrdiff_t i);

/// Construct from a range of elements.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_char_Destroy()` to free it when you're done using it.
MRC_API MR_std_vector_char *MR_std_vector_char_ConstructFromRange(const char *ptr, size_t size);
...
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_char_const_iterator_Destroy()` to free it when you're done using it.
...
/// Parameter `_this` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_std_vector_char_iterator_Destroy()` to free it when you're done using it.
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_char_const_iterator_DestroyArray()`.
...
/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API const MR_std_vector_char_const_iterator *MR_std_vector_char_const_iterator_OffsetPtr(const MR_std_vector_char_const_iterator *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API MR_std_vector_char_const_iterator *MR_std_vector_char_const_iterator_OffsetMutablePtr(MR_std_vector_char_const_iterator *ptr, ptrdiff_t i);
...
/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_std_vector_char_iterator_DestroyArray()`.
/// Use `MR_std_vector_char_iterator_OffsetMutablePtr()` and `MR_std_vector_char_iterator_OffsetPtr()` to access the array elements.
...
/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API const MR_std_vector_char_iterator *MR_std_vector_char_iterator_OffsetPtr(const MR_std_vector_char_iterator *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
MRC_API MR_std_vector_char_iterator *MR_std_vector_char_iterator_OffsetMutablePtr(MR_std_vector_char_iterator *ptr, ptrdiff_t i);
